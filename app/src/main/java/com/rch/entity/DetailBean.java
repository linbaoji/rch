...
public class DetailBean implements Serializable{
    ...
    private String carBaseConfigUrl;//
    ...
    public String getCarBaseConfigUrl() {
        return carBaseConfigUrl;
    }

    public void setCarBaseConfigUrl(String carBaseConfigUrl) {
        this.carBaseConfigUrl = carBaseConfigUrl;
    }
}
