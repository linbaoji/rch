...
public class OrderInfoEntity {
    ...
    private String orderUserSex;// 订单主键ID
    private String orderUserMobileEncryption;// 订单主键ID
    ...
    public String getOrderUserMobileEncryption() {
        return orderUserMobileEncryption;
    }

    public void setOrderUserMobileEncryption(String orderUserMobileEncryption) {
        this.orderUserMobileEncryption = orderUserMobileEncryption;
    }
